...
export default {
  ...
  methods: {
    itensDeLista1EstaoEmLista2(lista1: unknown[], lista2: unknown[]) {
  ...
  async created() {
    ...
    console.log(this.receitasEncontradas)
    this.receitasEncontradas = receitas.filter((receita) => {
      ...
      const possoFazerReceita = this.itensDeLista1EstaoEmLista2(receita.ingredientes, this.ingredientes);
